...
import {
  Box, Button, Heading, Grommet, ResponsiveContext, Tabs, Tab, TextInput,
} from 'grommet';
import { Search, FormClose } from 'grommet-icons';
import {
  setUserData, setListsData, setLinksData, setPublic, setShowLinks,
} from '../store/Actions';
...
const mapStateToProps = (state) => {
  const {
    user, showAlertStatus, show, publicPage, publicPageUsername, links, showLinks,
  } = state;
  return {
    user, showAlertStatus, show, publicPage, publicPageUsername, links, showLinks,
  };
...
class AppContainer extends PureComponent {
  ...
  render() {
    const {
      colNumber, bodyWidth, showSettings, showHome, valueSearch,
    } = this.state;
    const {
      user, showAlertStatus, publicPage, publicPageUsername,
    } = this.props;
            ...
            <Box fill>
              ...
              {!publicPage && !showSettings
                  ...
                  <>
                    ...
                    {user.isLogged
                    && !showHome
                    && <ListCategories bodyWidth={bodyWidth} colNumber={colNumber} />}
